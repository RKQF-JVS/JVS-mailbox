      ...
      <div class="user-info-card tenant-card">
        ...
        <div class="user-info-top">
          <div style="display: flex;flex-direction: column;align-items: center;margin-right: 12%">
            ...
            <div>
              <el-input ref="editAccount" v-if="editNameShow" v-model="realName" size="mini" @blur="realNameEdit"></el-input>
              <span v-else>
      ...
      <div class="user-info-card tenant-card">
        ...
        <div class="user-info-card-item">
          <div class="left">
            ...
            <b>账号</b>
            <span>
              <el-input v-if="editAccountShow" v-model="accountName" size="mini" ref="editAccount" @blur="accountNameEdit"></el-input>
        ...
        <div class="user-info-card-item">
          ...
          <div class="right">
             <jvs-button type="text" style="color: #3471FF;" @click="bindOprateHandle('wx')">{{(userdata.exceptions && userdata.exceptions.WECHAT_OPEN && userdata.exceptions.WECHAT_OPEN.nickname) ? '解除绑定' : '绑定微信'}}</jvs-button>
          </div>
        </div>
        <div class="user-info-card-item">
          <div class="left">
...
import {
  ...
  setPassWord, loginOff, updateAccountHead} from "@/api/user"
...
export default {
  ...
  created () {
    this.callbackUrl = location.origin + '/%23/login/callback?back=bind&client_id='+ client_id
    this.getUserInfo()
    this.getTenantInfo()
